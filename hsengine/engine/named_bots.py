    ...
    *,
    ...
    if move == "next":
        ...
        lines.append(
            ...
            "If the glance has a CALENDAR SESSION, they joined that meeting. "
            "That is required opening entropy. Do not call recent_thoughts. "
            "Do not lead with Latest thoughts. One hook from the session, "
            "then the floor. "
