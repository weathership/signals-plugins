    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "A silent partner: do the work, then speak one natural "
                "sentence if needed. Never say the word steer. Never read "
                "STEER or MONOLOGUE labels. Do not dump JSON or name Grok. "
