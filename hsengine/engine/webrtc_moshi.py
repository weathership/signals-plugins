...
SPOKEN_SYSTEM = (
    ...
    "files, terminal, browser, subagents, memory) — call hermes; it is "
    "the primary Grok agent with the full CLI surface, and it shares "
    "this same session so the transcript and memories are already there. "
