...
SPOKEN_SYSTEM = (
    ...
    "plot — call viz_show so it fades onto the video; viz_select to "
    "highlight a node; viz_clear to restore the clip. Do not describe a "
    "figure as on-screen unless viz_show returned ok. "
