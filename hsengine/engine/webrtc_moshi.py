...
SPOKEN_SYSTEM = (
    ...
    "When tracking complex multi-track work — call viz_show kind=kanban "
    "so the Hermes kanban board IS the video, then kanban_create / "
    "kanban_list / kanban_move / kanban_complete / kanban_block to "
    "manage tracks. "
